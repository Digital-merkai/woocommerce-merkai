...
if (is_user_logged_in()) {
    ...
    // Initialize default values in case $wallet_info is null or incomplete
    $wallet_structure = isset($wallet_info['structure']) && is_array($wallet_info['structure']) ? $wallet_info['structure'] : [];
    $wallet_balance = isset($wallet_info['balance']) ? $wallet_info['balance'] : 0;
    $wallet_bonuses = isset($wallet_info['bonuses']) ? $wallet_info['bonuses'] : 0;

    // Safely access nested structure values with defaults
    $minimum_topup_amount = isset($wallet_structure['minimum_topup_amount']) ? (float) $wallet_structure['minimum_topup_amount'] : 0.0;
    $card_balance_limit = isset($wallet_structure['card_balance_limit']) ? (float) $wallet_structure['card_balance_limit'] : 0.0;
    $bonuses_conversion_rate = isset($wallet_structure['bonus_conversion_rate']) ? (float) $wallet_structure['bonus_conversion_rate'] : 0.0;
...
<?php if (isset($wallet_info) && $wallet_info['code'] !== 500) { ?>
        ...
        <section class="merkai <?php echo $merkai_classes; ?>">
            <div class="merkai-payment-block">
                ...
                <div class="merkai-card-bonuses">
                        ...
                        <div class="merkai-card" style="color:<?php echo $accent_text_color; ?>; background:<?php echo $accent_color; ?>">
                            ...
                            <div class="merkai-balance-bonuses">
                                <div class="merkai-balance">
                                    <div>Balance</div>
                                    <div class="amount">
                                        $<span class="merkai-numbers merkai-balance-value" data-balance="<?php echo $wallet_balance; ?>"><?php echo $wallet_balance; ?></span>
                                    </div>
                                </div>
                                <div class="merkai-bonuses">
                                    <div>Bonuses</div>
                                    <div class="amount">
                                        <span class="merkai-numbers merkai-bonus-value" data-bonus="<?php echo $wallet_bonuses; ?>"><?php echo $wallet_bonuses; ?></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php if ($wallet_bonuses) { ?>
                        <?php
                        if ($wallet_bonuses * $bonuses_conversion_rate < $cart_total) {
                            $max_bonuses = $wallet_bonuses;
                            $max_bonuses_in_money = $wallet_bonuses * $bonuses_conversion_rate;
                        } else {
                        ...
                        <div class="merkai-conversion-rate">
                            ...
                            <div>
                                <div class="merkai-font-bold merkai-text-lg">Apply available bonuses</div>
