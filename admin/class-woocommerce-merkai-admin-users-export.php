 ...
 * @package Wocommerce_Merkai
 */
class Merkai_Users_Export_Page {
    /**
     * This function renders the contents of the page associated with the
     * Merkai_Users_Export_Menu that invokes the render method. In
     * the context of this plugin, this is the Merkai_Users_Export_Page class.
     *
     * @since     1.0.0
     */
    public function render()
    {
        ...
        foreach ($users as $user) {
            $user_array = array(
                ...
                'currency' => get_option('woocommerce_merkai_settings')[PAYNOCCHIO_CURRENCY_KEY],
                'type' => 'fiat',
                'status' => 'active'
            );
        ...
        <div class="wrap">
            <div class="merkai-flex merkai-flex-row merkai-items-center merkai-gap-4">
                <img src="'.plugin_dir_url( WOOCOMMERCE_MERKAI_BASENAME ) . 'assets/img/kopybara-logo.png" class="merkai-w-[100px]" /><h1 class="wp-heading-inline merkai-p-0">Merkai Users Export</h1>
            </div>
            
            <form action="" method="get">
                <input type="hidden" name="page" value="merkai-export-users" />
                <div class="merkai_filters">
                    <div class="merkai_filter">
                        <label for="date_from">
                    ...
                    <input type="submit" class="merkai_submit" id="filters" value="Filter" />
                </div>
        ...
        if (count($result) == 0) {
            ...
            echo '
                    <div class="merkai_buttons">
                        <a href="'.$export_url.'" class="merkai_button">Export Users</a>
                        <a href="'.$generate_url.'" class="merkai_button">Generating missing UUIDs</a>
                    </div>';
        }
        echo '</div>';
    }
